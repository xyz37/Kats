...
namespace ZO.Kats.Models.Entities
{
	...
	[System.Diagnostics.DebuggerDisplay("UserId:{UserId}, AccountNo:{AccountNo}, ReferenceDate:{ReferenceDate}, StockItemCode:{StockItemCode}, StockItemName:{StockItemName}, OrderType:{OrderType}, OrderNo:{OrderNo}, ContractType:{ContractType}, No:{No}, Price:{Price}, StockCount:{StockCount}, Amount:{Amount}, RequestDate:{RequestDate}, TxUserId:{TxUserId}, TxDate:{TxDate}, LastModifiedUserId:{LastModifiedUserId}, LastModified:{LastModified}", Name = "Contract")]
	public class Contract : EntityIdBase
	{
		/// <summary>
		/// UserId를 구하거나 설정합니다.
		/// </summary>
		...
		[Key]
		[Column(Order = 5, TypeName = "char"), MaxLength(7)]
